...
for key, value in characters.items():
    ...
    if planets.has_key(value['homeworld']):
        links.append({
            'source': value['name'],
            'target': planets[value['homeworld']]['name'],
            'value': 3
        })
...
fw = open('../templates/starwar.json', 'w')
fw.write(json.dumps({
    'nodes': nodes,
    'links': links
}))
